...
{
    public partial class CvOlustur_UserControl2 : UserControl
    {

        public CvOlustur_UserControl2()
        {
            InitializeComponent();
        }

        private void CvOlustur_UserControl2_Load(object sender, EventArgs e)
        {
