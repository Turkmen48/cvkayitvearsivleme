...
{
    public partial class EditPage_UserControl1 : UserControl
    {

        Database database = new Database();
        Services services = new Services();
        string fdogumYeriId = "bos";
        public EditPage_UserControl1()
        {
            InitializeComponent();
        ...
        private void EditPage_UserControl1_Load(object sender, EventArgs e)
        {
            ...
            DogumYeriId = fdogumYeriId;


        }
        public void setDogumYeri(string dogumYeriId)
        {
            fdogumYeriId = dogumYeriId;
        }
        public string Tc
        { ///tc kontrol get set
            get
        ...
        private bool TcDogrulaV2(string tcKimlikNo)
        {
        ...
        private void dogumYeri_Click(object sender, EventArgs e)
        {
